  ...
  return (
    <>
      ...
      <div className="container-lg flex border">
        <img src={comptiaaplus} alt="Testout cert from school" width="100" height="100" className="w-1/9 mx-4"/>
        <img src={testout} alt="Testout cert from school" width="100" height="100" className="w-1/9 mx-4"/>
      </div>
    </>
  );
};
